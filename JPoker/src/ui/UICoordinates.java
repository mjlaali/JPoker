...
public class UICoordinates {
    ...
    static {
        playerX1s[0] = 12; playerY1s[0] = 330;
        playerX1s[1] = 12; playerY1s[1] = 126;
        playerX1s[2] = 232; playerY1s[2] = 58;
        playerX1s[3] = 483; playerY1s[3] = 58;
        playerX1s[4] = 708; playerY1s[4] = 126;
        playerX1s[5] = 708; playerY1s[5] = 330;
        playerX1s[6] = 483; playerY1s[6] = 418;
        playerX1s[7] = 232; playerY1s[7] = 418;
